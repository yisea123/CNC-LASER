...
#define DEFAULT_STEPPER_DEACTIVE_TIME 1200 //IDKMSU 
...
//#define ENCODER_RATE_MULTIPLIER //IDKMSU        // If defined, certain menu edit operations automatically multiply the steps when the encoder is moved quickly
 ...
 */
#define SPINDLE_LASER_ENABLE  //IDKMSU
  ...
  //#define SPEED_POWER_SLOPE    118.4 //IDKMSU
  //#define SPEED_POWER_INTERCEPT  0   //IDKMSU
  //#define SPEED_POWER_MIN     5000   //IDKMSU
  //#define SPEED_POWER_MAX    30000    //IDKMSU SuperPID router controller 0 - 30,000 RPM

  #define SPEED_POWER_SLOPE      0.3922 //IDKMSU
  #define SPEED_POWER_INTERCEPT  0      //IDKMSU
  #define SPEED_POWER_MIN       .5      //IDKMSU
  #define SPEED_POWER_MAX      100      //IDKMSU 0-100%
#endif
